...
analyze_gene <- function(gene_name, cpm_values, metadata, expression_classes, plot_type = "boxplot") {
  
  expr_values <- cpm_values[gene_name, ]
  donor_list <- setNames(metadata$Donor, metadata$Sample)
  avg_by_donor <- tapply(expr_values, donor_list, mean, na.rm = TRUE)
  ...
  plot_data <- data.frame(
    ...
    Donor = donor_list[rownames(metadata)]
  )
